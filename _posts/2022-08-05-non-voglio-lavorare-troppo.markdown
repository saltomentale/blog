...
![Ti pagano per il valore che crei - immagine mercato agricolo]({{ '/assets/media/Ti-pagano-per-il-valore-che-crei-immagine-mercato-agricolo.jpg' | absolute_url }})Il tuo lavoro mi è d’aiuto, ecco a te dei soldi in cambio. Foto di [Alex Hudson](https://unsplash.com/@aliffhassan91?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
...
![Smettere di lavorare troppo a lungo - Orologio alla parete]({{ '/assets/media/Smettere-di-lavorare-troppo-a-lungo-Orologio-alla-parete.jpg' | absolute_url }})Se solo avessi un martello… Foto di [Renel Wackett](https://unsplash.com/@renelwackett?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
...
![Non voglio lavorare - Risultati lavorando più tempo]({{ '/assets/media/Non-voglio-lavorare-Risultati-lavorando-più-tempo.png' | absolute_url }})
...
![Non voglio lavorare - Risultati lavorando con più qualità]({{ '/assets/media/Non-voglio-lavorare-Risultati-lavorando-con-più-qualità.png' | absolute_url }})
...
![]({{ '/assets/media/Non-voglio-lavorare-amaca-in-mezzo-alla-natura.jpg' | absolute_url }})Foto di [Zach Betten](https://unsplash.com/@bettenz?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
