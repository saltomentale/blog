...
![Abitudini - omino Michelin ad un autodromo]({{ '/assets/media/Abitudini-omino-Michelin-ad-un-autodromo.jpg' | relative_url }})Foto di [Ye Massa](https://unsplash.com/@massa404?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
...
![Abituarsi a non guardare la TV - vecchia televisione impolverata]({{ '/assets/media/Abituarsi-a-non-guardare-la-TV-vecchia-televisione-impolverata.jpg' | relative_url }})Nelle nostre case dal [1954](https://it.wikipedia.org/wiki/Storia_della_televisione#Cronologia).  
...
![Leggere per abitudine - Immagine libreria pubblica di Stoccolma]({{ '/assets/media/Leggere-per-abitudine-Immagine-libreria-pubblica-di-Stoccolma.jpg' | relative_url }})La mia libreria personale ha più di 100’000 volumi. Mi basta solo aspettare qualche giorno per la consegna.  
...
![Tenere un diario - foto agenda]({{ '/assets/media/Tenere-un-diario-foto-agenda.jpg' | relative_url }})Ecco che le vecchie agende della banca tornano utili!  
...
![Abituarsi a notare le cose belle - Grazie]({{ '/assets/media/Abituarsi-a-notare-le-cose-belle-Grazie.jpg' | relative_url }})Foto di [Priscilla Du Preez](https://unsplash.com/@priscilladupreez?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText), intenzioni di SaltoMentale.
