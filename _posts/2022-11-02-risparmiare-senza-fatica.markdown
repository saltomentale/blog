...
![Ragazza che fa shopping e guarda tra le magliette]({{ '/assets/media/Ragazza-che-fa-shopping-e-guarda-tra-le-magliette.jpg' | relative_url }})Cosa cerchi lì dentro? Abbigliamento? Status? Divertimento? Compagnia?  
...
![Uomo seduto in piscina con bottiglie di alcolici]({{ '/assets/media/Uomo-seduto-in-piscina-con-bottiglie-di-alcolici.jpg' | relative_url }})Temo che nessuna automobile mi farà mai sembrare così cool. E mi sta bene così.  
...
![Risparmiare senza fatica - schema concettuale]({{ '/assets/media/Risparmiare-senza-fatica.png' | relative_url }})
