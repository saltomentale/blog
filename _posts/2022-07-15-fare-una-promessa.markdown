...
![Promessa fatta faccia preoccupata]({{ '/assets/media/Promessa-fatta-faccia-preoccupata.jpg' | relative_url }})Foto di [Norbert Tóth](https://unsplash.com/@tothnorex?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
...
![Adattamento edonistico – andamento soddisfazione per una promessa]({{ '/assets/media/Adattamento-edonistico-–-Promesse.png' | relative_url }})
...
![Aspettative e soddisfazione - grafico Andamento con e senza sorpresa]({{ '/assets/media/Aspettative-e-soddisfazione.png' | relative_url }})
...
![Rinforzo intermittente - Slot machine]({{ '/assets/media/Rinforzo-intermittente-Slot-machine.jpg' | relative_url }})Foto di [Ays Be](https://unsplash.com/@aysha_be?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
