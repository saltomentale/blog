...
![Mela marcia - singola mela]({{ '/assets/media/Mela-marcia-singola-mela.png' | absolute_url }})
...
![Mela marcia - contagio del cesto]({{ '/assets/media/Mela-marcia-contagio-del-cesto.png' | absolute_url }})
...
![Mela marcia - gruppo visto da fuori]({{ '/assets/media/Mela-marcia-gruppo-visto-da-fuori.png' | absolute_url }})
...
![Dito indice rimprovera bambino]({{ '/assets/media/Dito-indice-rimprovera-bambino.jpg' | absolute_url }})Il dito può servire ad indicare o a cavare gli occhi. Educare o punire. Foto di [Artyom Kabajev](https://unsplash.com/@artfilm?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
...
- [Mindset](https://amzn.to/3lEPr5K), della psicologa [Carol Dweck](https://en.wikipedia.org/wiki/Carol_Dweck), spiega in modo approfondito il concetto di mentalità dinamica e statica e le implicazioni di adottare una piuttosto che l’altra. [Qui in lingua originale](https://amzn.to/3PGMaRm).
